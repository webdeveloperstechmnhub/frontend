...
const TechStars = () => {
  ...
  return (
    ...
    <style>{`
      ...
      .ts-card:hover { box-shadow: 0 8px 32px rgba(30,64,175,0.18); }
      .ts-photo-placeholder { background: #e6e6e6; border: 2px dashed var(--tmh-ocean); border-radius: 18px; width: 100%; min-height: 180px; display: flex; align-items: center; justify-content: center; color: #aaa; font-size: 1.2rem; margin-bottom: 24px; }
      @media (max-width: 700px) {
        .ts-maincard { padding: 18px 4vw !important; }
        .ts-photo-placeholder { min-height: 120px; font-size: 1rem; }
      }
    `}</style>
      <div className="ts-fadein" style={{ width: '100%', maxWidth: 800, margin: '48px auto 0 auto', background: '#fff', borderRadius: 18, boxShadow: '0 4px 24px rgba(30,64,175,0.10)', border: '2px solid var(--tmh-ocean)', padding: '32px 40px' }}>
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 24 }}>
          <img src={geminiImg} alt="Google Gemini" style={{ maxWidth: 180, borderRadius: 12, boxShadow: '0 2px 8px rgba(30,64,175,0.10)' }} />
        </div>
      ...
      <div className="ts-card ts-fadein" style={{ background: 'var(--tmh-cream)', borderRadius: 14, border: '1.5px solid var(--tmh-sky)', margin: '24px 0', padding: '24px 18px', boxShadow: '0 2px 8px rgba(30,64,175,0.06)' }}>
